...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock(Fragment, null, [
        ...
        : (_ctx.formType === 'boolean')
          ? (openBlock(), createBlock("div", _hoisted_4$2, [
              createVNode("input", {
                ...
                type: "checkbox",
                checked: _ctx.input.ref.value === 'true',
                onChange: _cache[2] || (_cache[2] = $event => (_ctx.input.setValue($event.target.checked.toString()))),
                id: _ctx.name
          ...
          : (openBlock(), createBlock("input", {
              ...
              type: _ctx.formType,
              value: _ctx.input.ref.value,
              onInput: _cache[3] || (_cache[3] = $event => (_ctx.input.setValue($event.target.value))),
    ...
    (_ctx.formType !== 'boolean')
      ? (openBlock(), createBlock("small", _hoisted_5$1, toDisplayString(_ctx.helpText), 1 /* TEXT */))
      : createCommentVNode("v-if", true)
  ], 64 /* STABLE_FRAGMENT */))
}
